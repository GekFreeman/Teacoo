...
public class ModifyUserPop extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ModifyUserPop frame = new ModifyUserPop(userID);
	 ...
	 * Create the frame.
	 */
	public ModifyUserPop(String userID) {
		this.userID=userID;
		setResizable(false);
		// 去掉窗口的装饰
		setUndecorated(true);
		...
		btnY.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				u.updateUser(UserManagement.userl, UserManagement.userID);	
				dispose();
			}
		});
