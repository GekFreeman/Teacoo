...
//确认管理员新增题目弹窗
public class InsertPop extends JFrame {
	static String QID;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InsertPop frame = new InsertPop(QID);
	...
	public InsertPop(String QID) {
		...
		container=new JPanel(){protected void paintComponent(Graphics g) {
			ImageIcon BG = new ImageIcon(Toolkit.getDefaultToolkit().getImage("image/management/insertpop.png"));
		...
		btnY.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				UpdateDB.addtoTeacoo(QID,TeaCooManagement.Qtype,TeaCooManagement.Stem,TeaCooManagement.optionA,				
						TeaCooManagement.optionB,TeaCooManagement.optionC, TeaCooManagement.optionD,TeaCooManagement.Analysis,TeaCooManagement.Answer,TeaCooManagement.level);
				dispose();
			}
		});
