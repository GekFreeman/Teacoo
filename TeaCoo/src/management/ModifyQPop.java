...
public class ModifyQPop extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ModifyUserPop frame = new ModifyUserPop(QID);
	...
	public ModifyQPop(String QID) {
		...
		container=new JPanel(){protected void paintComponent(Graphics g) {
			ImageIcon BG = new ImageIcon(Toolkit.getDefaultToolkit().getImage("image/management/modifypop.png"));
		...
		btnY.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				UpdateDB.updateTeacoo(TeaCooManagement.mQtype, TeaCooManagement.mStem, TeaCooManagement.moptionA,
						TeaCooManagement.moptionB, TeaCooManagement.moptionC, TeaCooManagement.moptionD, 
						TeaCooManagement.mAnalysis,TeaCooManagement.mAnswer, TeaCooManagement.mlevel,QID);
